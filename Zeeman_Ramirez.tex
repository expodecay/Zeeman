...
\abstract{
\noindent
By applying a magnetic field to mercury vapor, we were able to measure the splitting of the energy levels of mercury atoms. The measurements allowed us to calculate the value of the Bohr magneton. For pi-transitions, the measured value is $\mu_B = 5.62 \pm 0.20 \times 10^{-05} \text{eV T}^{-1}$ and $\mu_B = 5.39 \pm 0.27 \times 10^{-05} \text{eV T}^{-1}$. For sigma-transitions, $\mu_B = 5.18 \pm 0.40 \times 10^{-05} \text{eV T}^{-1}$, and $\mu_B = 5.80 \pm 0.61 \times 10^{-05} \text{eV T}^{-1}$.
} 
